...
HD_PWD='D:/DSD/Lab/sig_var/sig_var.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sig_var.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sig_var.tcl -notrace
