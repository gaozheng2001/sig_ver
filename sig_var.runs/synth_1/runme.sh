...
HD_PWD='D:/DSD/Lab/sig_var/sig_var.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sig_var.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sig_var.tcl
